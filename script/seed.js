...
async function seed() {
    ...
    const products = await Promise.all([
        ...
        Product.create({
            ...
            category: 'laptop',
            image: '/images/imagine-working-bg.png',
            rating: 4.1,
            quantity: 17,
        }),
        Product.create({
        ...
        Product.create({
            ...
            category: 'laptop',
            image: '/images/lenovo-yoga-bg.png',
            rating: 4.6,
            quantity: 11,
        }),
        ...
        Product.create({
            ...
            category: "desktop",
            image: "/images/lenovo-think-bg.png",
            rating: 4.4,
            quantity: 18,
        }),
        Product.create({
